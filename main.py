...
def get_single_page(title, base_url, url, headers):
    global class_tag_list, id_tag_list
    ...
    if response.status_code == 200:
        ...
        # Clean response
        page_text = part_clean(page_text, class_list_to_delete, id_list_to_delete)
...
get_single_page(title, base_url, url, headers)